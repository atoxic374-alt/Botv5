...
window.electronAPI = {
  ...
  tsForceReset: (email) => apiCall('POST', '/api/ts/force-reset', { email: email || '' }),
  ...
  // Account Creator
  acSettings:      ()        => apiCall('GET',    '/api/ac/settings'),
  acSaveSettings:  (payload) => apiCall('POST',   '/api/ac/settings', payload),
  acState:         ()        => apiCall('GET',    '/api/ac/state'),
  acStart:         (cfg)     => apiCall('POST',   '/api/ac/start', cfg),
  acStop:          ()        => apiCall('POST',   '/api/ac/stop'),
  acForceReset:    ()        => apiCall('POST',   '/api/ac/force-reset'),
  acAccounts:      ()        => apiCall('GET',    '/api/ac/accounts'),
  acClearLog:      ()        => apiCall('POST',   '/api/ac/clear-log'),
